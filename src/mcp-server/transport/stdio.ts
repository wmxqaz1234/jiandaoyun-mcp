...
import { InitTransportServerFunction } from '../shared/types.js';
...
export const initStdioServer: InitTransportServerFunction = async (
  ...
  logger.info(
    `[StdioServerTransport] Connecting to MCP Server, userAccessToken: ${Boolean(userAccessToken)}, appId: ${appId}, appKey: ${Boolean(appKey)}`,
  );
